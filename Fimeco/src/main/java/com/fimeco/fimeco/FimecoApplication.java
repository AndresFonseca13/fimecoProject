...
import com.fimeco.fimeco.domain.permission.PermissionRepository;
...
//	@Bean
//	CommandLineRunner init(UserRepository userRepository, RolRepository rolRepository, PermissionRepository permissionRepository){
//		return args -> {
